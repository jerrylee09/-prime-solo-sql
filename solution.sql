...
--SELECT username FROM syntax_practice WHERE account_balance = (select max(account_balance) FROM syntax_practice) ORDER BY account_balance ASC;
-- 6. Get the username and account balance of the 3 users with the lowest balances, sort lowest to highest balance.
--SELECT username FROM syntax_practice WHERE account_balance = (select min(account_balance) FROM syntax_practice) ORDER BY account_balance DESC;
-- 7. Get all users with account balances that are more than $100.
--SELECT username FROM syntax_practice WHERE account_balance < 100;
--8. Add a new record.
--INSERT INTO syntax_practice (username, city, transactions_completed, transactions_attempted, account_balance) VALUES ('jerry', 'minneasota', 5, 10, 355.80)
